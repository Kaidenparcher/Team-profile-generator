...
const circleTemplate = (text, textColor, shapeColor) => `
  <svg width="300" height="200">
    ...
    <text x="150" y="115" font-size="60" font-weight="bold" text-anchor="middle" fill="${textColor}">${text}</text>
  </svg>
`;
...
const triangleTemplate = (text, textColor, shapeColor) => `
  <svg width="300" height="200">
    ...
    <text x="150" y="135" font-size="60" font-weight="bold" text-anchor="middle" fill="${textColor}">${text}</text>
  </svg>
`;
